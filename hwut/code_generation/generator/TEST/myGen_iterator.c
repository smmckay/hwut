...
static int   myGen4_implement(myGen4_t* it);
...
myGen4_0_implement(myGen4_t* it)
{
    it->x = (int)1000;
    {
        float primary_front = (((float)(it->x)) - 1);
        float primary_back  = (((float)(it->x)) + 1);
...
myGen4_1_implement(myGen4_t* it)
{
    it->x = (int)100;
    {
        float primary_front = (((float)(it->x)) - 3);
        float primary_back  = (((float)(it->x)) + 3);
        float step_size     = (float)1;
        float index         = (float)(it->hwut.cursor.index[1]);
        float delta         = index * step_size;
        float value         = primary_front + delta;
...
myGen4_3_implement(myGen4_t* it)
{
    it->x = (int)10;
    {
        float primary_front = (((float)(it->x)) - 0.5);
        float primary_back  = (((float)(it->x)) + 1.25);
...
myGen4_4_implement(myGen4_t* it)
{
    it->x = (int)0;
    {
        ...
        float primary_front = (((float)(it->x)) - 3);
        float primary_back  = (((float)(it->x)) + 1.5);
...
static int   myGen2_implement(myGen2_t* it);
...
static int   myGen3_implement(myGen3_t* it);
...
static int   myGen1_implement(myGen1_t* it);
