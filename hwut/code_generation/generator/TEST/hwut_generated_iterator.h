#ifndef INCLUDE_GUAGE_HWUT_GENERATOR_hwut_generated_iterator_h
#define INCLUDE_GUAGE_HWUT_GENERATOR_hwut_generated_iterator_h
#include <stdint.h>
...
extern void               myGen4_key_set(myGen4_t* it, hwut_cursor_key_t key);
...
extern void               myGen2_key_set(myGen2_t* it, hwut_cursor_key_t key);
...
extern void               myGen3_key_set(myGen3_t* it, hwut_cursor_key_t key);
...
extern void               myGen1_key_set(myGen1_t* it, hwut_cursor_key_t key);
...
#endif /* INCLUDE_GUAGE_HWUT_GENERATOR_hwut_generated_iterator_h */
