...
/* FUNCTION: other_position ____________________________________________________
 *                                                                            */
typedef const mine_t         (*other_position_FUNC)();
typedef const mine_t         (*other_position_FUNCS)(int CallCount);

extern void         other_position_RETURN(const mine_t* ReturnValue);
extern void         other_position_RETURNS(int N, ...);
extern void         other_position_CALL(other_position_FUNC FuncP);
extern void         other_position_CALLS(other_position_FUNCS FuncP);
