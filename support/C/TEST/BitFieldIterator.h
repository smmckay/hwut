#ifndef INCLUDE_GUAGE_HWUT_GENERATOR_BitFieldIterator_h
...
extern hwut_cursor_key_t Error_key_max(); 
extern hwut_cursor_key_t Error_key_get(Error_t* it);
extern int               Error_key_set(Error_t* it, hwut_cursor_key_t key);
 ...
 * 
 * The total number of iterations is equal to 'max. key + 1'.                */
extern hwut_cursor_key_t Three_key_max(); 
extern hwut_cursor_key_t Three_key_get(Three_t* it);
extern int               Three_key_set(Three_t* it, hwut_cursor_key_t key);
 ...
 * 
 * The total number of iterations is equal to 'max. key + 1'.                */
extern hwut_cursor_key_t Two_key_max(); 
extern hwut_cursor_key_t Two_key_get(Two_t* it);
extern int               Two_key_set(Two_t* it, hwut_cursor_key_t key);
 ...
 * 
 * The total number of iterations is equal to 'max. key + 1'.                */
extern hwut_cursor_key_t One_key_max(); 
extern hwut_cursor_key_t One_key_get(One_t* it);
extern int               One_key_set(One_t* it, hwut_cursor_key_t key);
...
#endif /* INCLUDE_GUAGE_HWUT_GENERATOR_BitFieldIterator_h */
