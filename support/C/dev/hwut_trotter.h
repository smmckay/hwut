...
/* vim:setlocal ft=c: 
 *
 * This file implements a n-dimensional space 'cursor' in C, where the
 * walks in each direction are totally free. The 'hwut_trotter' is a 
 * generalization of the 'hwut_cursor'. Both are based on a finite set
 * of parameters. For the 'hwut_cursor', the settings are generated
 * from combinations of optional settings for those parameters. The 
 * 'hwut_trotter' receives the settings of N parameters from a set of 
 * N functions,  

 * is bound by a set of parameters AND the options for their setting. The 
 * 'hwut_trotter' is bound 
